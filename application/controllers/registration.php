		...
		if($to_emails)	// Check emails is available
		{
			...
			*/
				...
				if(filter_var($to_email, FILTER_VALIDATE_EMAIL))	// Check valid email
				{
					...
					//$message=nl2br($rec_content[$keys]).'<br /><br />Please click on following link, to leave your feedback about him/ her.<br /><a href="'.base_url('recommendation/index/'.urlencode(base64_encode($insert_id)).'/'.urlencode(base64_encode($to_email))).'">Reply your Feedback</a><br /><br />Regards<br />EZCV';
					$message= '<table width="820px" border="0" align="center">
							<tr bgcolor="#266a86">
								<td scope="row" style="height:126px;">
									<a href="http://ezcv.in/" style="text-decoration:none;"><img style="margin-left:20px; margin-top:3px; margin-bottom:3px;" src='.base_url("assets/img/ezcv-logo.png").' alt="EZCV" title="EZCV" width="125" height="106"/></a>
							...
							<tr>
								<td scope="row">
									<p style="font-family:Arial, Helvetica, sans-serif; font-size:14px; padding:0px 20px 5px 20px; margin-top:10px;">'.nl2br($rec_content[$keys]).'<br /><br />Please click on following link, to leave your feedback about him/ her.<br /><a href="'.base_url('recommendation/index/'.urlencode(base64_encode($insert_id)).'/'.urlencode(base64_encode($to_email))).'">Reply your Feedback</a></p>
								</td>
							</tr>
							<tr>
								<td scope="row">
