	 		...
	 		<div class="span7 offset1 templateForm">
	 			...
	 			<form class="form-horizontal">
					  ...
					  <div class="control-group ">
					    ...
					    <div class="controls">
					      <textarea rows="3" class="input span8" type="text"  placeholder="Something about yourself"></textarea>
					    </div>
					  </div>
					  <div class="control-group ">
					...
					<button class="removeButton">Remove</button>
					  ...
					  <!--============================================Skills==========================================-->
							<div class="control-group ">
						    	...
						    	<div class="controls">
						      		<input class="span5" type="text"  placeholder="Skill 1 and small description">
						      		<button>Add</button>
					...
					<button class="removeButton">Remove</button>
 					...
 					<!--============================================Areas of interest==========================================-->
							<div class="control-group ">
						    	...
						    	<div class="controls">
						    		<input class="span3" type="text"  placeholder="Interest 1">
						      		<input class="span5" type="text"  placeholder="Description">
						      		<button>Add</button>
						      		 <button>Remove</button>
						    	</div>
						  	</div>
						  	...
						  	<!--============================================Areas of interest==========================================-->
							<div class="control-group ">
						    	<label class="control-label">Personal Strength</label>
						    	<div class="controls">
						      		<input class="span3" type="text"  placeholder="Strength 1">
						      		<input class="span5" type="text"  placeholder="Description">
						      		<button>Add</button>
						      		 <button>Remove</button>
						    	</div>
