...
<div class="form_title">
	<a href="#" class="btn_reg"  >Register</a>
	<a href="#" class="btn_sig" >Sign In</a>
</div>
<div class="left_form">
			...
			<div >
				...
				<form>
					<div>
						...
						<input type="checkbox" id="c1" class="form_checkbox login" /> Remember me
	        			<label for="c1" style="display:none;"><span></span>Remember me</label>
					</div>
					<div>
						...
						<span id="login" class="forget clickr" style="display:none;">Back</span>
					</div>
