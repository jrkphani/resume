<div class="row-fluid">
	<div class="span12">
		<div class="download-main">
			...
			<div class="download-main-inner">
				<form id="search_form" class="form-inline" action="<?=base_url('member/searchSkills')?>" method="POST">
	...
	<div class="span12">
		...
		<table>
			...
			{?>
			<tr id="<?=$single->id?>"><td><a href="<?=base_url('member/searchSkills')?>/<?=$single->id?>" ><?=$single->string?></a><span onclick="remove('<?=$single->id?>');">X</span></td></tr>
			<?}?>
		</table>
	</div>
</div>
